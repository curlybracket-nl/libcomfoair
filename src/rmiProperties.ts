...
export const VentilationUnitProperties = {
    NODE: {
        ...
        "SERIAL_NUMBER": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.NODE, propertyId: 0x04, dataType: PropertyDataType.CN_STRING, access: "ro" },
        // "UNKNOWN_5": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.NODE, propertyId: 0x05, dataType: PropertyDataType.CN_UINT8 },
        "FIRMWARE_VERSION": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.NODE, propertyId: 0x06, dataType: PropertyDataType.CN_UINT32, access: "ro" },
        // "UNKNOWN_7": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.NODE, propertyId: 0x07, dataType: PropertyDataType.CN_UINT32 },
        "MODEL_NUMBER": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.NODE, propertyId: 0x08, dataType: PropertyDataType.CN_STRING, access: "ro" },
        ...
        "ARTICLE_NUMBER": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.NODE, propertyId: 0x0B, dataType: PropertyDataType.CN_STRING, access: "ro" },
        // "UNKNOWN_12": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.NODE, propertyId: 0x0C, dataType: PropertyDataType.CN_STRING },
        "CURRENT_COUNTRY": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.NODE, propertyId: 0x0D, dataType: PropertyDataType.CN_STRING, access: "ro" },
        "VENTILATION_UNIT_NAME": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.NODE, propertyId: 0x14, dataType: PropertyDataType.CN_STRING, access: "ro" },
    },
    TEMPHUMCONTROL: {
        ...
        "RMOT_HEATING_PERIOD": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.TEMPHUMCONTROL, propertyId: 0x02, dataType: PropertyDataType.CN_INT16, access: "rw" },
        "RMOT_COOLING_PERIOD": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.TEMPHUMCONTROL, propertyId: 0x03, dataType: PropertyDataType.CN_INT16, access: "rw" },
        "PASSIVE_TEMPERATURE_CONTROL": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.TEMPHUMCONTROL, propertyId: 0x04, dataType: PropertyDataType.CN_UINT8, access: "rw" },
        ...
        "HUMIDITY_COMFORT_CONTROL": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.TEMPHUMCONTROL, propertyId: 0x06, dataType: PropertyDataType.CN_UINT8, access: "rw" },
        "HUMIDITY_PROTECTION": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.TEMPHUMCONTROL, propertyId: 0x07, dataType: PropertyDataType.CN_UINT8, access: "rw" },
        ...
        "TARGET_TEMPERATURE_HEATING": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.TEMPHUMCONTROL, propertyId: 0x0A, dataType: PropertyDataType.CN_INT16, access: "rw" },
        "TARGET_TEMPERATURE_NORMAL": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.TEMPHUMCONTROL, propertyId: 0x0B, dataType: PropertyDataType.CN_INT16, access: "rw" },
        "TARGET_TEMPERATURE_COOLING": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.TEMPHUMCONTROL, propertyId: 0x0C, dataType: PropertyDataType.CN_INT16, access: "rw" },
    ...
    VENTILATIONCONFIG: {
        ...
        "VENTILATION_SPEED_AWAY": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.VENTILATIONCONFIG, propertyId: 0x03, dataType: PropertyDataType.CN_INT16, access: "rw" },
        "VENTILATION_SPEED_LOW": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.VENTILATIONCONFIG, propertyId: 0x04, dataType: PropertyDataType.CN_INT16, access: "rw" },
        "VENTILATION_SPEED_MEDIUM": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.VENTILATIONCONFIG, propertyId: 0x05, dataType: PropertyDataType.CN_INT16, access: "rw" },
        "VENTILATION_SPEED_HIGH": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.VENTILATIONCONFIG, propertyId: 0x06, dataType: PropertyDataType.CN_INT16, access: "rw" },
        "HEIGHT_ABOVE_SEA_LEVEL": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.VENTILATIONCONFIG, propertyId: 0x07, dataType: PropertyDataType.CN_UINT8 },
        ...
        "VENTILATION_CONTROL_MODE": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.VENTILATIONCONFIG, propertyId: 0x09, dataType: PropertyDataType.CN_UINT8 },
        ...
        "BATHROOM_SWITCH_ACTIVATION_DELAY": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.VENTILATIONCONFIG, propertyId: 0x0B, dataType: PropertyDataType.CN_INT16 },
        "BATHROOM_SWITCH_DEACTIVATION_DELAY": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.VENTILATIONCONFIG, propertyId: 0x0C, dataType: PropertyDataType.CN_UINT8 },
        "BATHROOM_SWITCH_MODE": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.VENTILATIONCONFIG, propertyId: 0x0D, dataType: PropertyDataType.CN_UINT8 },
        ...
        "UNBALANCE": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.VENTILATIONCONFIG, propertyId: 0x12, dataType: PropertyDataType.CN_INT16 },
    ...
    NODECONFIGURATION: {
        ...
        "MAINTAINER_PASSWORD": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.NODECONFIGURATION, propertyId: 0x03, dataType: PropertyDataType.CN_STRING },
        "ORIENTATION": { node: NodeTypes.VENTILATION_UNIT, unit: UnitTypes.NODECONFIGURATION, propertyId: 0x04, dataType: PropertyDataType.CN_UINT8 },
